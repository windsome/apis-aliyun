...
var Dayu = function (_Base) {
    ...
    (0, _createClass3.default)(Dayu, [{
        ...
        value: function sendSMS(args) {
            ...
            var commonArgs = { Action: 'SendSms', Format: 'json', AccessKeyId: this.accessKeyId, SignatureMethod: 'HMAC-SHA1', Timestamp: timestamp };
            ...
            return this.get("http://ecs.aliyuncs.com/?" + strQuery).then(function (retobj) {
        ...
        key: 'sendSMSCode',
        value: function sendSMSCode(phone, code, outId) {
            return this.sendSMS({ PhoneNumber: phone, SignName: '帝利文化', TemplateCode: "SMS_76425078", TemplateParam: { code: code }, OutId: outId });
        }
    }]);
    return Dayu;
}(_base2.default);
